...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-200 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default: "bg-primary text-black hover:bg-[oklch(0.75_0.12_75)] active:bg-[oklch(0.65_0.10_70)] hover:shadow-lg active:scale-95 font-semibold",
        destructive:
          "bg-destructive text-white hover:bg-destructive/90 focus-visible:ring-destructive/20 dark:focus-visible:ring-destructive/40 dark:bg-destructive/60 hover:shadow-md active:scale-95",
        outline:
          "border border-primary bg-transparent text-primary shadow-xs hover:bg-primary hover:text-black active:scale-95 font-semibold",
        secondary:
        ...
        link: "text-primary underline-offset-4 hover:underline hover:text-[oklch(0.75_0.12_75)]",
      },
      size: {
